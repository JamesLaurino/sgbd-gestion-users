<x-app-layout>
    <div class="container mx-auto py-8">
        <h1 class="text-2xl font-bold mb-6">Modifier un Nouvel Utilisateur</h1>
        ...
        <form action="{{ route('users.update') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" class="w-full border border-gray-300 px-3 py-2" value="{{ old('name', $user->email) }}">
                @error('email')
                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <button type="submit" class="bg-blue-500 text-dark px-4 py-2">Créer</button>
        </form>
    </div>
</x-app-layout>
